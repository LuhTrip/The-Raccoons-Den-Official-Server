SandboxVars = {
    ...
    AshenMPRanking = {
        mainUiTitle = "The Den's Ranking's",
    ...
    VFE = {
        ...
        HouseWeapons = true,
        -- Multiplier to weapons spawning in houses (Requires previous option enabled) Min: 0.10 Max: 10.00 Default: 1.00
    ...
    MPBugFixesCombined = {
        -- Max craft history entries per player to prevent PlayerCraftHistory.save buffer overflow. Min: 20 Max: 1000 Default: 100
    ...
    PhunServer = {
        ...
        WorkshopPollingIntervalMinutes = 25,
