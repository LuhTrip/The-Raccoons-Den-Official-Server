SandboxVars = {
    ...
    AdaptiveTraits = {
        ...
        AdrenalineJunkie_GainKills = 100,
    ...
    PhunServer = {
        ...
        NotificationCountdown = "1800;60;10",
        NotificationChime = false,
        -- Min: 1 Max: 100 Default: 15
        QuitDelaySeconds = 15,
        PlayersOnMap = 1,
        PlayersOnMiniMap = 1,
        -- Min: 0 Max: 10000 Default: 1500
    ...
    SuppInMilitary = {
        -- Min: 0.01 Max: 20.00 Default: 1.00
        Rate = 1.0,
    },
    SuppInPolice = {
        -- Min: 0.01 Max: 20.00 Default: 0.01
        Rate = 0.01,
    },
    OldPainless = {
        -- Min: 0.01 Max: 20.00 Default: 0.01
    ...
    BetterSafehouse = {
        EnableSafehouseViewer = false,
        EnhancedInvites = true,
        -- Min: 0 Max: 20 Default: 0
        MaxJoinedSafehouses = 2,
    ...
    Cannibalism = {
        -- Min: 0 Max: 999999 Default: 3
        ZombieMeatProduce = 3,
        PoisonousZombieMeat = true,
        -- Min: 0 Max: 999999 Default: 5
        ZombieMeatPoisonPower = 5,
        -- Min: 0 Max: 999999 Default: 3
        HumanMeatProduce = 3,
        -- Min: 0 Max: 999999 Default: 1
        ...
        -- Min: 0 Max: 999999 Default: 10
        StageTwoInsanityPoints = 10,
        -- Min: 0 Max: 999999 Default: 30
